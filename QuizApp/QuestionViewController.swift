...
class QuestionViewController: UIViewController {
    ...
    func setupView() {
        ...
        bAnswer1.titleEdgeInsets = .init(top: 0, left: 30, bottom: 0, right: 0)
        bAnswer1.titleLabel?.font = UIFont.boldSystemFont(ofSize: 22)
        ...
        bAnswer2.titleEdgeInsets = .init(top: 0, left: 30, bottom: 0, right: 0)
        bAnswer2.titleLabel?.font = UIFont.boldSystemFont(ofSize: 22)
        ...
        bAnswer3.titleEdgeInsets = .init(top: 0, left: 30, bottom: 0, right: 0)
        bAnswer3.titleLabel?.font = UIFont.boldSystemFont(ofSize: 22)
        ...
        bAnswer4.titleEdgeInsets = .init(top: 0, left: 30, bottom: 0, right: 0)
        bAnswer4.titleLabel?.font = UIFont.boldSystemFont(ofSize: 22)
